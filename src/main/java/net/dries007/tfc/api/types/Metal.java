...
public class Metal extends IForgeRegistryEntry.Impl<Metal>
{
    ...
    public enum ItemType
    {
        ...
        ANVIL(true, 1728, ItemAnvil::new), // these are just decomp recipes
        TUYERE(true, 576),
        ...
        PICK(true, 288, ItemMetalTool::new),
        PICK_HEAD(true, 360, true, "XXXXX", "X   X", " XXX ", "XXXXX"),
        SHOVEL(true, 144, ItemMetalTool::new),
        SHOVEL_HEAD(true, 216, true, "X   X", "X   X", "X   X", "X   X", "XX XX"),
        AXE(true, 288, ItemMetalTool::new),
        AXE_HEAD(true, 432, true, "X XXX", "    X", "     ", "    X", "X XXX"),
        HOE(true, 144, ItemMetalHoe::new),
        HOE_HEAD(true, 216, true, "XXXXX", "     ", "  XXX", "XXXXX"),
        CHISEL(true, 72, ItemMetalChisel::new),
        CHISEL_HEAD(true, 108, true, "X X", "X X", "X X", "X X", "X X"),
        SWORD(true, 432, (metal, itemType) -> new ItemMetalSword(metal)),
        SWORD_BLADE(true, 576, true, "XXX  ", "XX   ", "X   X", "X  XX", " XXXX"),
        MACE(true, 432, ItemMetalTool::new),
        MACE_HEAD(true, 504, true, "XX XX", "X   X", "X   X", "X   X", "XX XX"),
        SAW(true, 144, ItemMetalTool::new),
        SAW_BLADE(true, 216, true, "XXX  ", "XX   ", "X   X", "    X", "  XXX"),
        JAVELIN(true, 72, ItemMetalJavelin::new),
        JAVELIN_HEAD(true, 144, true, "XX   ", "X    ", "     ", "X   X", "XX XX"),
        HAMMER(true, 720, ItemMetalTool::new),
        HAMMER_HEAD(true, 1080, true, "XXXXX", "     ", "     ", "XX XX", "XXXXX"),
        PROPICK(true, 144, ItemProspectorPick::new),
        PROPICK_HEAD(true, 216, true, "XXXXX", "    X", " XXX ", " XXXX", "XXXXX"),
        KNIFE(true, 108, ItemMetalTool::new),
        KNIFE_BLADE(true, 144, true, "XX X", "X  X", "X  X", "X  X", "X  X"),
        SCYTHE(true, 288, ItemMetalTool::new),
        SCYTHE_BLADE(true, 432, true, "XXXXX", "X    ", "    X", "  XXX", "XXXXX"),
        SHEARS(true, 216, ItemMetalShears::new),
